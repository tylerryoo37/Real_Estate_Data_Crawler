# Extracting property links for House Only
...
# Click on 'House' to filter properties
...
while status:
    try:
        ...
        property_df.to_csv("test_athome_links_house.csv", encoding='utf-8-sig')
...
property_df = pd.DataFrame(list(zip(property_links, locations)), columns=['links', 'locations'])
property_df.to_csv("test_athome_links_house_final.csv", encoding='utf-8-sig')
