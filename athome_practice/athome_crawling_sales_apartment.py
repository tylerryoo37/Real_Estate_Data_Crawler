# Extracting property links for Apartment Only
...
# Click on 'Apartment' to filter properties
...
while status:
    try:
        ...
        property_df.to_csv("test_athome_links_apartment.csv", encoding='utf-8-sig')
...
property_df = pd.DataFrame(list(zip(property_links, locations)), columns=['links', 'locations'])
property_df.to_csv("test_athome_links_apartment_final.csv", encoding='utf-8-sig')
